...
def test_eticket_summary():
    """Summary test that always passes and prints info."""
    print(f"\n{'='*60}")
    print(f"E-TICKET OCR TEST SUMMARY")
    print(f"{'='*60}")
    print(f"Document: eticket-Mr-CHUA-Nickolas Teck Yang.pdf")
    print(f"Purpose: Validate OCR extraction with real Ancileo policy")
    print(f"{'='*60}")
